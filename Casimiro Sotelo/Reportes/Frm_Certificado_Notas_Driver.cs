...
{
    public partial class Frm_Certificado_Notas_Driver : Form
    {
        Rpt_Certificado_Driver report = new Rpt_Certificado_Driver();
        ...
        int codigo = 0;
        public Frm_Certificado_Notas_Driver(int people, string carrera, string pertenece, string cadena, string TotalCredito, string promedio, string codigo_usuario, string TotalHoras, string Nombre)
        {
            InitializeComponent();
            ...
            RvCertificado02.ReportSource = report;
        }
    }
}
